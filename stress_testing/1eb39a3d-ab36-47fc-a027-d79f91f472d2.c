...
int main(void) {
    ...
    if (uint_to_double(1000) != 1000.0) {
        return 1;
    }

    // uint that's larger than INT_MAX, so we can't just use cvtsi2sd
    if (uint_to_double(4294967200) != 4294967200.0) {
        return 2;
    }

    // ulong that's smaller than LONG_MAX
    if (ulong_to_double(138512825844) != 138512825844.0) {
        return 3;
    }

    // ulong that's larger than LONG_MAX
    if (ulong_to_double(10223372036854775816) != 10223372036854775808.0) {
        return 4;
    }
     ...
     */
    if (ulong_to_double(9223372036854776832) != 9223372036854775808.0) {
        return 5;
    }
     ...
     */
    if (ulong_to_double(9223372036854776833) != 9223372036854777856.0) {
        return 6;
    }

    /* This value is closer to 9223372036854775808.0 than 9223372036854777856.0,
     * so round down */
    if (ulong_to_double(9223372036854776831) != 9223372036854775808.0) {
        return 7;
    }

    /* This value is closer to 9223372036854775808.0 than 9223372036854777856.0,
     * so round down */
    if (ulong_to_double(9223372036854776830) != 9223372036854775808.0) {
        return 8;
    }
