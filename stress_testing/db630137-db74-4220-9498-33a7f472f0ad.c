...
int test_add_negative_index(void) {
    unsigned int unsigned_arr[12] = {0, 0, 2, 0, 0, 0, 0, 0, 0, 0, 42};
    unsigned int *end_ptr = unsigned_arr + 12;

    unsigned int *ptr = end_ptr + -10;
    return *ptr == 2;
}
...
int test_add_different_index_types(void) {
    ...
    double *ptr2 = double_arr + 5;
    double *ptr3 = double_arr + 5;
    double *ptr4 = double_arr + 5;
...
//     double *ptr2 = end_ptr - 5;
//     double *ptr3 = end_ptr - 5;
//     double *ptr4 = end_ptr - 5;
//     return (ptr1 == ptr2 && ptr1 == ptr3 && ptr1 == ptr4 && *ptr4 == 6.0);
// }
