...
unsigned long ul = 18446460386757245432; // 0xfffe_fdfc_fbfa_f9f8

int main(void) {

    unsigned long *ul_ptr = &ul;
    *ul_ptr &= -1000;
    if (ul != 18446460386757244952 /* 0xfffe_fdfc_fbfa_f818 */) {
        return 1; // fail
    }
    *ul_ptr |= 4294967040;

    if (ul != 18446460386824683288 /* 0xfffe_fdfc_ffff_ff18 */) {
        return 2; // fail
    }
    int i = 123456;
    unsigned int ui = 4042322160; // 0xf0f0_f0f0
