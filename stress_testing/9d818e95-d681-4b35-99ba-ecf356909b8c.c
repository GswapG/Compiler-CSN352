...
int main(void) {
    ...
    if (schar_to_uint(sc) != 4294967286) {
        return 6;
    }
    ...
    if (long_to_schar(17592186044416)) {  // should be null byte
        return 18;
    }

    sc = (signed char)-126;
    if (ulong_to_schar(9224497936761618562) != sc) {
        return 19;
    }
    ...
    if (long_to_uchar(-36283884951096) != uc) {
        return 22;
    }

    if (ulong_to_uchar(9224497936761618632) != uc) {
        return 23;
    }
